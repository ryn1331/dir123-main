    ...
    <footer className="bg-foreground text-background/80" role="contentinfo">
      <div className="container py-10 md:py-14">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-10">
          ...
          <div>
            <h4 className="font-body font-semibold mb-3 text-xs uppercase tracking-[0.15em] text-background/40">{t("footer.infoLabel")}</h4>
            <ul className="space-y-2 text-xs text-background/50">
              <li>{t("footer.faq")}</li>
          ...
          <div>
            <h4 className="font-body font-semibold mb-3 text-xs uppercase tracking-[0.15em] text-background/40">{t("footer.contactLabel")}</h4>
            <ul className="space-y-2 text-xs text-background/50">
